...
@app.route('/all_pupils/<schoolform_name>')
def all_pupils(schoolform_name):
    pupils=mongo.db.pupils_collection.find().sort([("Surname", 1)])
    return render_template("allpupils.html", schoolform_name=schoolform_name, pupils=pupils, forms=mongo.db.schoolforms_collection.find())

# Add then insert pupil  
    
@app.route('/add_pupil')
def add_pupil():
    schoolforms = mongo.db.schoolforms_collection.find().sort([("Form_Name", 1)])
    return render_template('addpupil.html', schoolforms = schoolforms)
...
def add_report(schoolform_name, pupil_id):
    ...
    schoolforms = mongo.db.schoolforms_collection.find().sort([("Form_Name", 1)])
    return render_template("addreport.html", pupil=pupil, pupil_id=pupil_id, schoolform_name=schoolform_name, subjects=subjects, schoolforms=schoolforms)
...
def edit_report(schoolform_name, pupil_id, report_id):
    ...
    subjects = mongo.db.subjects_collection.find().sort([("Title", 1)])
    schoolforms = mongo.db.schoolforms_collection.find().sort([("Form_Name", 1)])
    return render_template("editreport.html", report=report, pupil_id=pupil_id, schoolform_name=schoolform_name, subjects=subjects, schoolforms=schoolforms)
